...
target("Chap10-a")
    set_kind("binary")
    add_files("src/Chap10/a.c")

target("Chap10-b")
    set_kind("binary")
    add_files("src/Chap10/b.c")

target("Chap10-c")
    set_kind("binary")
    add_files("src/Chap10/c.c")

target("Chap10-d")
    set_kind("binary")
    add_files("src/Chap10/d.c")

target("Chap10-e")
    set_kind("binary")
    add_files("src/Chap10/e.c")

target("Chap10-f")
    set_kind("binary")
    add_files("src/Chap10/f.c")

target("Chap10-g")
    set_kind("binary")
    add_files("src/Chap10/g.c")

target("Chap10-h")
    set_kind("binary")
    add_files("src/Chap10/h.c")

target("Chap10-i")
    set_kind("binary")
    add_files("src/Chap10/i.c")

target("Chap10-j")
    set_kind("binary")
    add_files("src/Chap10/j.c")

target("Chap10-k")
    set_kind("binary")
    add_files("src/Chap10/k.c")

target("Chap10-n")
    set_kind("binary")
    add_files("src/Chap10/n.c")
--
